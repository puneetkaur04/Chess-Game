...
play(Board) :-
    ...
    execute_command(playerB, NewBoard, NextNewBoard), nl,
    play(NextNewBoard).
...
% Color will be black for playerA; OppositeColor is playerA (white)
